export const products = [
    ...
    },
    {
        ...
        discountPercent: "20",
        isNew: true,
        imageUrl: "/products/neel-bahaar/3.jpg",
        category: "phulkari-cotton",
        sizes: ["S", "M", "L", "XL", "XXL"],
        images: [
            "/products/neel-bahaar/3.jpg",
    ...
    {
        id: 5,
        title: "White Full-Sleeve Embroidered Top (Elegant Style)",
        discountedPrice: "1,299",
        originalPrice: "1,999",
        discountPercent: "28",
        isNew: true,
    ...
    {
        id: 6,
        title: "Red Embroidery Salwar Suit (Heritage Edition)",
        discountedPrice: "2,149",
        originalPrice: "2,599",
        discountPercent: "17",
        isRestocked: true,
    ...
    {
        id: 7,
        title: "Bombkai-Inspired Suit Set (Lightweight)",
        discountedPrice: "2,699",
        originalPrice: "2,999",
        discountPercent: "18",
        badge: "ODISHA EDIT",
    ...
    {
        id: 8,
        title: "Cotton Office Kurta Set (Classic Fit)",
        discountedPrice: "1,599",
        originalPrice: "1,999",
        discountPercent: "20",
        isNew: true,
        imageUrl: "/products/neel-bahaar/4.jpg",
        category: "phulkari-cotton",
        sizes: ["M", "L", "XL", "XXL"],
        images: [
            "/products/neel-bahaar/4.jpg",
